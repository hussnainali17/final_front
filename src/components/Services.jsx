...
const items = [
  { id: 1, name: 'Item 1', price: '$10', img: 'https://i.postimg.cc/Z0kytRBF/ser1.png', text: 'Source from industry hubs  '},
  { id: 2, name: 'Item 2', price: '$20', img: 'https://i.postimg.cc/44BpRzcD/Mask-group-2.png', text: 'Source from industry hubs  '},
  { id: 3, name: 'Item 3', price: '$30', img: 'https://i.postimg.cc/Fsz3r7g7/Mask-group-3.png', text: 'Source from industry hubs  '}, 
  { id: 4, name: 'Item 4', price: '$40', img: 'https://i.postimg.cc/bN5bsp3L/Mask-group-4.png', text: 'Source from industry hubs  '},
];
        ...
        {items.map(item => (
          <div key={item.id} className='relative border border-gray-300 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow'>
            ...
            <div className='absolute right-4 bottom-12 rounded-full p-1 bg-blue-200'>
              <img src="https://i.postimg.cc/pXhnF39Z/search.png" alt="" />
            </div>
            <div className='p-2'>
